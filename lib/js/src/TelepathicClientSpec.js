        ...
        describe("register(client)", (function () {
                return Jest.test("registers the linkId with the server", (function () {
                              ...
                              var handleMessage = function (message) {
                                ...
                                var action;
                                try {
                                  action = Js_option.getExn(TelepathicActions.Decode[/* action */1](json));
                                }
                                catch (_exn$1){
                              ...
                              var client = TelepathicClient.make(/* Some */[socket], expectedLinkId, (function () {
                                      return /* () */0;
                                    }), "test-url");
                              var run = function () {
        ...
        describe("sendMessage(~linkId, ~text)", (function () {
                return Jest.test("uses the WebSocket client to send the message", (function () {
                              ...
                              var handleMessage = function (message) {
                                var action;
                                try {
                                  action = Js_option.getExn(TelepathicActions.Decode[/* action */1](JSON.parse(message)));
                                }
                                catch (_exn){
