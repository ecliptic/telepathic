...
function getName() {
  return Js_primitive.null_to_opt(localStorage.getItem(Config.Data[/* keys */0][/* client */0][/* userName */0]));
}

function updateName(name) {
  localStorage.setItem(Config.Data[/* keys */0][/* client */0][/* userName */0], name);
  return /* () */0;
}
